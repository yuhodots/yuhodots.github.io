...
module.exports = async (program, directory, suppliedStage, port, {
  ...
  if (stage === `develop` && process.env.GATSBY_HOT_LOADER === `fast-refresh` && (0, _localEslintConfigFinder.hasLocalEslint)(program.directory)) {
    finalConfig = (0, _webpackUtils.ensureRequireEslintRules)(finalConfig);
  }
