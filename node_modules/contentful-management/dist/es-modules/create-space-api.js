...
export default function createSpaceApi(_ref) {
  ...
  return {
    ...
    "delete": function deleteSpace() {
      ...
      return endpoints.space.del(http, {
        spaceId: raw.sys.id
      });
    },
    ...
    update: function updateSpace() {
      var raw = this.toPlainObject();
      return endpoints.space.update(http, {
        spaceId: raw.sys.id
    ...
    getEnvironment: function getEnvironment(environmentId) {
      var raw = this.toPlainObject();
      return endpoints.environment.get(http, {
        spaceId: raw.sys.id,
    ...
    getEnvironments: function getEnvironments() {
      ...
      var raw = this.toPlainObject();
      return endpoints.environment.getMany(http, {
        spaceId: raw.sys.id,
        query: query
      }).then(function (data) {
    ...
    createEnvironment: function createEnvironment() {
      ...
      var raw = this.toPlainObject();
      return endpoints.environment.create(http, {
        spaceId: raw.sys.id
    ...
    createEnvironmentWithId: function createEnvironmentWithId(id, data, sourceEnvironmentId) {
      var raw = this.toPlainObject();
      return endpoints.environment.createWithId(http, {
        spaceId: raw.sys.id,
        environmentId: id,
    ...
    getWebhook: function getWebhook(id) {
      var raw = this.toPlainObject();
      return endpoints.webhook.get(http, {
        spaceId: raw.sys.id,
    ...
    getWebhooks: function getWebhooks() {
      var raw = this.toPlainObject();
      return endpoints.webhook.getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
    ...
    createWebhook: function createWebhook(data) {
      var raw = this.toPlainObject();
      return endpoints.webhook.create(http, {
        spaceId: raw.sys.id
    ...
    createWebhookWithId: function createWebhookWithId(id, data) {
      var raw = this.toPlainObject();
      return endpoints.webhook.createWithId(http, {
        spaceId: raw.sys.id,
        webhookDefinitionId: id
      }, data).then(function (data) {
        return wrapWebhook(http, data);
    ...
    getRole: function getRole(id) {
      var raw = this.toPlainObject();
      return endpoints.role.get(http, {
        spaceId: raw.sys.id,
        roleId: id
      }).then(function (data) {
    ...
    getRoles: function getRoles() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return endpoints.role.getMany(http, {
        spaceId: raw.sys.id,
    ...
    createRole: function createRole(data) {
      var raw = this.toPlainObject();
      return endpoints.role.create(http, {
        spaceId: raw.sys.id
      }, data).then(function (data) {
        return wrapRole(http, data);
      });
    ...
    createRoleWithId: function createRoleWithId(id, roleData) {
      var raw = this.toPlainObject();
      return endpoints.role.createWithId(http, {
        spaceId: raw.sys.id,
        roleId: id
    ...
    getSpaceUser: function getSpaceUser(userId) {
      var raw = this.toPlainObject();
      return endpoints.user.getForSpace(http, {
        spaceId: raw.sys.id,
        userId: userId
      }).then(function (data) {
    ...
    getSpaceUsers: function getSpaceUsers() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return endpoints.user.getManyForSpace(http, {
        spaceId: raw.sys.id,
        query: createRequestConfig({
          query: query
        }).params
    ...
    getSpaceMember: function getSpaceMember(id) {
      var raw = this.toPlainObject();
      return endpoints.spaceMember.get(http, {
        spaceId: raw.sys.id,
        spaceMemberId: id
      }).then(function (data) {
    ...
    getSpaceMembers: function getSpaceMembers() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return endpoints.spaceMember.getMany(http, {
        spaceId: raw.sys.id,
        query: createRequestConfig({
          query: query
        }).params
    ...
    getSpaceMembership: function getSpaceMembership(id) {
      var raw = this.toPlainObject();
      return endpoints.spaceMembership.get(http, {
        spaceId: raw.sys.id,
    ...
    getSpaceMemberships: function getSpaceMemberships() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return endpoints.spaceMembership.getMany(http, {
        spaceId: raw.sys.id,
        query: createRequestConfig({
          query: query
        }).params
    ...
    createSpaceMembership: function createSpaceMembership(data) {
      var raw = this.toPlainObject();
      return endpoints.spaceMembership.create(http, {
        spaceId: raw.sys.id
      }, data).then(function (response) {
    ...
    createSpaceMembershipWithId: function createSpaceMembershipWithId(id, data) {
      var raw = this.toPlainObject();
      return endpoints.spaceMembership.createWithId(http, {
        spaceId: raw.sys.id,
        spaceMembershipId: id
      }, data).then(function (response) {
        return wrapSpaceMembership(http, response);
    ...
    getTeamSpaceMembership: function getTeamSpaceMembership(teamSpaceMembershipId) {
      var raw = this.toPlainObject();
      return endpoints.teamSpaceMembership.get(http, {
        spaceId: raw.sys.id,
    ...
    getTeamSpaceMemberships: function getTeamSpaceMemberships() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return endpoints.teamSpaceMembership.getMany(http, {
        spaceId: raw.sys.id,
        query: createRequestConfig({
          query: query
        }).params
    ...
    */
    createTeamSpaceMembership: function createTeamSpaceMembership(teamId, data) {
      var raw = this.toPlainObject();
      return endpoints.teamSpaceMembership.create(http, {
        spaceId: raw.sys.id,
        teamId: teamId
      }, data).then(function (data) {
        return wrapTeamSpaceMembership(http, data);
    ...
    getApiKey: function getApiKey(id) {
      var raw = this.toPlainObject();
      return endpoints.apiKey.get(http, {
        spaceId: raw.sys.id,
        apiKeyId: id
      }).then(function (data) {
    ...
    getApiKeys: function getApiKeys() {
      var raw = this.toPlainObject();
      return endpoints.apiKey.getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
    ...
    getPreviewApiKeys: function getPreviewApiKeys() {
      var raw = this.toPlainObject();
      return endpoints.previewApiKey.getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
    ...
    getPreviewApiKey: function getPreviewApiKey(id) {
      var raw = this.toPlainObject();
      return endpoints.previewApiKey.get(http, {
        spaceId: raw.sys.id,
        previewApiKeyId: id
      }).then(function (data) {
    ...
    createApiKey: function createApiKey(payload) {
      var raw = this.toPlainObject();
      return endpoints.apiKey.create(http, {
        spaceId: raw.sys.id
    ...
    createApiKeyWithId: function createApiKeyWithId(id, payload) {
      var raw = this.toPlainObject();
      return endpoints.apiKey.createWithId(http, {
        spaceId: raw.sys.id,
        apiKeyId: id
      }, payload).then(function (data) {
        return wrapApiKey(http, data);
    ...
    createEnvironmentAliasWithId: function createEnvironmentAliasWithId(environmentAliasId, data) {
      var raw = this.toPlainObject();
      return endpoints.environmentAlias.createWithId(http, {
        spaceId: raw.sys.id,
    ...
    getEnvironmentAlias: function getEnvironmentAlias(environmentAliasId) {
      var raw = this.toPlainObject();
      return endpoints.environmentAlias.get(http, {
        spaceId: raw.sys.id,
        environmentAliasId: environmentAliasId
      }).then(function (data) {
        return wrapEnvironmentAlias(http, data);
    ...
    getEnvironmentAliases: function getEnvironmentAliases() {
      var raw = this.toPlainObject();
      return endpoints.environmentAlias.getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
    ...
    getScheduledActions: function getScheduledActions(query) {
      var raw = this.toPlainObject();
      return endpoints.scheduledAction.getMany(http, {
        spaceId: raw.sys.id,
        query: query
    ...
    createScheduledAction: function createScheduledAction(data) {
      var raw = this.toPlainObject();
      return endpoints.scheduledAction.create(http, {
        spaceId: raw.sys.id
      }, data).then(function (response) {
